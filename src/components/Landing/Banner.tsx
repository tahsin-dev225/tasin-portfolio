      ...
      <section className="relative flex flex-col-reverse lg:flex-row  gap-5 px-10 items-center md:py-[74px] overflow-hidden">
        ...
        <div className="w-full  z-40">
          <div className="smm:mx-auto w-full sm:pt-10 sm:w-max lg:w-full">
            <p className="uppercase font-sans text-[14px] xsm:text-[15px] sm:text-[16px] md:text-[18px] lg:text-[20px] tracking-wide text-gray-300 mb-4">
              I’m <span className="text-[#a42dff]">Tasin</span>,{" "}
              <Typewriter
                text={[
            ...
            <h1 className="text-[15px] xsm:text-[22px] smm:text-[28px] sm:text-[36px]  md:text-5xl lg:text-4xl elg:text-5xl xl:text-[52px] font-bold leading-snug mb-6">
              Building Modern Website <br />
              with React, Next.js & Tailwind
            </h1>

            <p className="text-gray-400 leading-relaxed text-[15px] max-w-lg mb-6">
            ...
            <button className=" primary-button px-3 py-1.5 sm:py-2.5 sm:px-6 mt-10">
              Here Me..
            </button>
          </div>
